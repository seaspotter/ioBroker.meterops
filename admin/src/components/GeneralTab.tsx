            ...
            <div>
                <div>
                    <TextField
                        ...
                        helperText='Instance that meter/group/kpi/tariff states get automatically configured for history logging on, e.g. "influxdb.0". Leave empty to configure history manually per state.'
                        style={{ minWidth: 400 }}
                ...
                <div>
                    <TextField
                        ...
                        helperText="How often every meter's current value is snapshotted for period-based KPIs (self_consumption_ratio, autarky, cop, ...)."
                        style={{ minWidth: 400 }}
                        value={snapshotCron}
